...
public class Subject8 extends AppCompatActivity{
    ...
    private EditText grade1EditText, credit1EditText, grade2EditText, credit2EditText, grade3EditText, credit3EditText, grade4EditText, credit4EditText, grade5EditText, credit5EditText,
            grade6EditText, credit6EditText, grade7EditText, credit7EditText, grade8EditText, credit8EditText, lastSemesterTotalCreditEditText, lastSemesterCGPAEditText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_subject8);
    ...
    public void calculate(View view){
        ...
        if (TextUtils.isEmpty(grade8String)){
            grade5EditText.setError("Grade cannot be empty.");
            return;
        }
        ...
        if (gradeToPointer.isGradeLetter(grade7String)){
            Toast.makeText(this,"Grade for subject 7 is not a grade.",Toast.LENGTH_SHORT).show();
            return;
        }

        if (gradeToPointer.isGradeLetter(grade8String)){
            Toast.makeText(this,"Grade for subject 7 is not a grade.",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        int credit8Integer = Integer.parseInt(credit8String);
        ...
        if (credit8Integer < 1 || credit8Integer > 4){
            Toast.makeText(this,"Invalid credit.",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        double grade7ToMaxPointer = gradeToPointer.GradeToMaxPointer(grade7String.toUpperCase());
        double grade8ToMaxPointer = gradeToPointer.GradeToMaxPointer(grade8String.toUpperCase());
        ...
        double grade7ToMinPointer = gradeToPointer.GradeToMinPointer(grade7String.toUpperCase());
        double grade8ToMinPointer = gradeToPointer.GradeToMinPointer(grade7String.toUpperCase());

        totalCurrentCredit = credit1Integer + credit2Integer + credit3Integer + credit4Integer + credit5Integer + credit6Integer + credit7Integer + credit8Integer;
        ...
        totalMaxPointer = (grade1ToMaxPointer*credit1Integer) + (grade2ToMaxPointer*credit2Integer) + (grade3ToMaxPointer*credit3Integer) + (grade4ToMaxPointer*credit4Integer)
                + (grade5ToMaxPointer*credit5Integer) + (grade6ToMaxPointer*credit6Integer) + (grade7ToMaxPointer*credit7Integer) + (grade8ToMaxPointer*credit8Integer);
        totalMinPointer = (grade1ToMinPointer*credit1Integer) + (grade2ToMinPointer*credit2Integer) + (grade3ToMinPointer*credit3Integer) + (grade4ToMinPointer*credit4Integer)
                + (grade5ToMinPointer*credit5Integer) + (grade6ToMinPointer*credit6Integer) + (grade7ToMinPointer*credit7Integer) + (grade8ToMinPointer*credit8Integer);
